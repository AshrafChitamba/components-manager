...
import { errorMsg, successMsg } from "./chalk-themes.js";
export const createFolder = async (folderPath) => {
    ...
    try {
        ...
        if (!fs.existsSync(folderRelativePath)) {
            ...
            fs.writeFileSync(`${folderRelativePath}/index.ts`, "// This file exports all your modules");
        ...
        // otherwise
            ...
            console.log(errorMsg(`Folder name ${folderName} already exists on path ${folderPath}`));
        }
    }
    catch (error) {
        console.log(errorMsg(`Failded to create folder ${folderName} path ${folderPath}`));
    }
};
